...
template <typename T>
void operator<< (std::ofstream&, const LinkedList<T>&);

template <typename T>
void operator>> (std::ifstream&, LinkedList<T>&);
...
public:
	...
	friend void operator<< <T> (std::ofstream&, const LinkedList<T>&);
	friend void operator>> <T> (std::ifstream&, LinkedList<T>&);
	...
	template <typename U>
	LinkedList<T> filter(const U& filterValue, bool (*filterFcn)(const T&, const U&));
};

template <typename T>
LinkedList<T> operator+ (const T&, const LinkedList<T>&);

template <typename T>
LinkedList<T> operator+ (const LinkedList<T>&, const T&);
...
template<typename T>
template<typename U>
LinkedList<T> LinkedList<T>::filter(const U& filterValue, bool (*filterFcn)(const T&, const U&))
{
	LinkedList<T> result_list;
	ListElement* current_element = head;
	while (current_element)
	{
		if (filterFcn(*(current_element->element), filterValue))
		{
